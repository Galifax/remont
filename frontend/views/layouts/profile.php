...
<div class="wrap">
    <div class="container-fluid">
        ...
        <li><a href="<?=Url::to(['/order'])?>" ><i class="fa fa-cogs" aria-hidden="true"><p>Настройки</p></a></i></li>
        <li><a href="<?=Url::to(['/site/logout'])?>" ><i class="fa fa-cogs" aria-hidden="true"><p>Выйти</p></a></i></li>
        </ul>
        </div>
